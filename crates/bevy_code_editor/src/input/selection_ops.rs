...
impl SelectionState {
    // ========== Primary cursor / SelectionCollection sync ==========
    ...
    /// imperative-update helpers see the up-to-date offset (e.g. after the
    /// SelectionCollection was mutated directly by undo/redo or `set_text`).
