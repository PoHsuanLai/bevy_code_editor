...
pub mod prelude {
    ...
    pub use crate::view::{
        Block, BlockLayoutConfig, BlockProvider, BlockSource, DisplayLayout, FontConfig,
        LayoutWrap, TextEnginePlugin, TextEnginePlugins, TextView, TextViewState, TextViewViewport,
    };
}
