...
impl Plugin for CodeEditorPlugin {
    fn build(&self, app: &mut App) {
        ...
        // `bevy_instanced_text_editor::apply_instant_scroll` (instant when
...
/// registered by `bevy_instanced_text_editor::InstancedTextEditPlugin`.
...
/// `bevy_instanced_text_editor::InstancedTextEditPlugin`. Handlers here cover multi-cursor,
