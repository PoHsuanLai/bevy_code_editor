...
| **[`bevy_text_interaction`](crates/bevy_text_interaction)** | Shared UI primitives: clipboard, selection, caret rendering, picking observers. No ropey dep. | [![crates.io](https://img.shields.io/crates/v/bevy_text_interaction.svg)](https://crates.io/crates/bevy_text_interaction) [![docs.rs](https://docs.rs/bevy_text_interaction/badge.svg)](https://docs.rs/bevy_text_interaction) |
| **[`bevy_text_editor`](crates/bevy_text_editor)** | Rope-backed editable text: edit history, undo/redo, typed-char insertion, anchors. | [![crates.io](https://img.shields.io/crates/v/bevy_text_editor.svg)](https://crates.io/crates/bevy_text_editor) [![docs.rs](https://docs.rs/bevy_text_editor/badge.svg)](https://docs.rs/bevy_text_editor) |
